...
public class EnrollmentController {
    ...
    public ResponseEntity<?> updateProgress(
        ...
        Integer percentage = enrollmentService.updateLessonCompleted(userId, courseId, completedLessons);
        if (percentage != null) {
    ...
    private EnrollmentDTO convertToDTO(Enrollment enrollment) {
        ...
        int percentage = enrollmentService.calculateCompletionPercentage(enrollment.getUser().getUserId(), enrollment.getCourse().getCourseId(), enrollment.getCompletedLessonsCount());
